...
- Added Python lesson 50 in Kazakh, Russian and English: stable source identifiers, exact decimal comparisons, rejection by reason, and source-owned numeric rendering with localized lesson maps.
