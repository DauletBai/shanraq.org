...
ALLOWED = {
    ...
    ("11-cases", "ru"): {"үйлеріміз", "мектептеріміз", "үй", "лер", "іміз", "мектеп", "тер", "сөз", "барыс", "жатыс", "білмеймін"},
    ("12-ambiguity", "ru"): {"ат", "жылқы", "есім", "үй", "баспана", "сөз", "білмеймін"},
    ("13-entities", "ru"): {"шахмат", "сурет", "сұрақ"},
    ("14-intent", "ru"): {"сұрақ", "қашан", "қайда", "уақыт", "орын"},
    ("15-abstain", "ru"): {"шахмат", "сурет", "сұрақ", "қашан", "қайда", "уақыт", "орын", "білмеймін", "қай", "үйірме", "нақтылаңыз", "бір", "үйірмені", "атаңыз", "па", "ба", "сұрақты", "таңдаңыз", "іздеу"},
    ("16-catalog", "ru"): {"жазба", "саны"},
    ("17-lookup", "ru"): {"білмеймін", "бірнеше", "жоқ", "мәлімет", "тоқта", "түрі", "үйірме"},
    ("18-provenance", "ru"): {"білмеймін", "бірнеше", "дереккөз", "жоқ", "күні", "мәлімет", "тексерілген", "тоқта", "түрі", "үйірме"},
    ("19-template", "ru"): {"білмеймін", "бірнеше", "дереккөз", "жоқ", "күні", "мәлімет", "тексерілген", "тоқта", "түрі", "уақыт", "уақыты", "үйірме", "үйірмесінің"},
    ("20-expiry", "ru"): {"білмеймін", "бір", "бірнеше", "дереккөз", "ескірген", "жоқ", "және", "күні", "нақтылаңыз", "сұрақ", "тексерілген", "тоқта", "түрі", "уақыт", "уақыты", "қайда", "қашан", "үйірме", "үйірмесінің"},
    ("21-labels", "ru"): {"белгі", "белгісіз", "уақыт", "қате"},
    ("22-splits", "ru"): {"бақылау", "бөлік", "жинақ", "оқыту", "сұрақ", "қайталанған", "қате"},
    ("23-classifier", "ru"): {"білмеймін", "уақыт"},
    ("24-gate", "ru"): {"білмеймін", "уақыт", "уақыты", "қайда", "қашан"},
    ("25-metrics", "ru"): {"анықталмайды", "белгілі", "белгісіз", "белгісізге", "білмеймін", "дұрыс", "дәлдік", "толықтық", "уақыт", "уақыты", "қайда", "қашан", "үлесі"},
    ("26-qazaq-ir", "ru"): {"бағдарлама", "мектептерімізде", "оқу", "табылмады", "іміз", "іске", "қатесі", "қосу", "қосылмады", "қосымша", "үлгісі"},
    ("27-boundary", "ru"): {"болады", "білмеймін", "бір", "нақтылаңыз", "сұрақ", "сөз", "суреттің", "түрі", "уақыт", "уақыты", "қайда", "қашан", "шахматтың", "үйірме", "өтеді"},
    ("28-benchmark", "ru"): {"бақыланған", "бөлу", "есептелмеді", "ең", "еңбек", "жаңа", "көп", "мен", "ортаңғы", "саны", "сұрау", "тікелей", "төлемі", "уақыт", "іске", "қашан", "қосу", "құны", "құрылғы"},
    ("29-audit", "ru"): {"анықталмады", "білмеймін", "бірнеше", "бұл", "дейін", "дереккөз", "жазба", "жоқ", "кілт", "күнге", "күнгі", "саны", "сұрақ", "тексерілген", "тоқта", "түрі", "уақыт", "уақыты", "із", "қайда", "қашан", "үйірмесінің"},
    ("30-cli", "ru"): {"жазыңыз", "күн", "сұрақ", "түрінде", "із", "қате", "қашан", "қолдану"},
}
