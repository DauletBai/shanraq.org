...
var messages = map[string]map[string]string{
	...
	"search.title":        {"kz": "Іздеу", "ru": "Поиск", "en": "Search"},
	"search.scope":        {"kz": "Іздеу аймағы", "ru": "Область поиска", "en": "Search in"},
	"search.in_articles":  {"kz": "Мақалалар", "ru": "Статьи", "en": "Articles"},
	"search.in_listings":  {"kz": "Жылжымайтын мүлік", "ru": "Недвижимость", "en": "Real estate"},
	"search.placeholder":  {"kz": "Іздеу…", "ru": "Поиск…", "en": "Search…"},
	"search.submit":       {"kz": "Іздеу", "ru": "Найти", "en": "Search"},
	"search.results_for":  {"kz": "Сұраныс бойынша", "ru": "По запросу", "en": "Results for"},
	"search.nresults":     {"kz": "нәтиже", "ru": "результатов", "en": "results"},
	"search.empty":        {"kz": "Ештеңе табылмады. Басқа сөзбен көріңіз.", "ru": "Ничего не найдено. Попробуйте другие слова.", "en": "Nothing found. Try different words."},
	"search.prompt":       {"kz": "Іздеу үшін сөз енгізіңіз.", "ru": "Введите запрос для поиска.", "en": "Type a query to search."},
