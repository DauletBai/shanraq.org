...
var messages = map[string]map[string]string{
	...
	"sub.gadgets":       {"kz": "Гаджеттер", "ru": "Гаджеты", "en": "Gadgets"},
	"sub.space":         {"kz": "Ғарыш", "ru": "Космос", "en": "Space"},
	"sub.software":      {"kz": "Бағдарламалар", "ru": "Софт", "en": "Software"},
	"sub.cybersecurity": {"kz": "Киберқауіпсіздік", "ru": "Кибербезопасность", "en": "Cybersecurity"},
	"sub.telecom":       {"kz": "Телеком", "ru": "Телеком", "en": "Telecom"},
	"sub.gaming":        {"kz": "Ойындар", "ru": "Игры", "en": "Gaming"},
	"sub.autotech":      {"kz": "Автотехнологиялар", "ru": "Автотехнологии", "en": "Auto tech"},
	// opinion
