...
- **[Rust: с нуля до своего органайзера](/course/rust?lang=ru)** — уроки публикуются поэтапно; доступные уроки перечислены в оглавлении. Продолжение выходит по пять уроков сразу на трёх языках.
...
- **[Rust: алғашқы қадамнан жеке жоспарлау құралына дейін](/course/rust?lang=kz)** — сабақтар кезең-кезеңімен жарияланады; қолжетімді сабақтар мазмұнда көрсетілген. Жалғасы үш тілде бес сабақтан жарияланады.
...
- **[Rust: from zero to your own organizer](/course/rust?lang=en)** — available lessons are listed in the course contents; more arrive five at a time in all three languages.
...
By publishing, you agree to these rules.`},
	...
	"pricing": {
		"ru": {Title: "Тарифы", Body: `Мы верим, что доступ к информации и знанию должен быть бесплатным. Поэтому чтение, курсы и подписка не стоят ничего.
...
Все цены указаны в тенге и могут корректироваться. Об изменениях мы сообщаем заранее.`},
		"kz": {Title: "Тарифтер", Body: `Ақпарат пен білімге қолжетімділік тегін болуы керек деп сенеміз. Сондықтан оқу да, курстар да, жазылу да тегін.
...
Барлық баға теңгемен және өзгеруі мүмкін. Өзгерістер туралы алдын ала хабарлаймыз.`},
		"en": {Title: "Pricing", Body: `We believe access to information and to knowledge should be free. Reading, the courses and the newsletter cost nothing.
