...
|---|---|---|
| Весь Казахстан | 20,8 млн | 25 000 ₸ |
| Алматы | 2,2 млн | 8 175 ₸ |
| Костанайская область | 834 тыс. | 5 000 ₸ |
| Костанай | 276 тыс. | 2 877 ₸ |
| Качар | 9,6 тыс. | 1 000 ₸ |

Не прямая пропорция потому, что баннер на страницах места видят не только его жители, а проверка, постановка и показ заказа стоят одинаково при любом охвате. Минимальная цена заказа — 1 000 ₸.
...
|---|---|---|
| Бүкіл Қазақстан | 20,8 млн | 25 000 ₸ |
| Алматы | 2,2 млн | 8 175 ₸ |
| Қостанай облысы | 834 мың | 5 000 ₸ |
| Қостанай | 276 мың | 2 877 ₸ |
| Качар | 9,6 мың | 1 000 ₸ |

Тура пропорция емес, себебі жердің бетіндегі баннерді сол жердің тұрғындарынан гөрі көбірек адам көреді, ал тапсырысты тексеру, қою және көрсету шығыны қамтудан тәуелсіз. Тапсырыстың ең төмен бағасы — 1 000 ₸.
...
|---|---|---|
| All of Kazakhstan | 20.8 m | 25,000 ₸ |
| Almaty | 2.2 m | 8,175 ₸ |
| Kostanay region | 834,000 | 5,000 ₸ |
| Kostanay | 276,000 | 2,877 ₸ |
| Kachar | 9,600 | 1,000 ₸ |

Not straight proportion, because a banner on a place's pages is seen by more than that place's residents, and reviewing, scheduling and serving a booking costs the same whatever its reach. The minimum price of an order is 1,000 ₸.
