...
- 🎓 **Free courses** — Go (50 lessons), Python (55 lessons) and SQL (13 lessons), plus **Rust: from zero to your own organizer**, released five lessons at a time in Kazakh, Russian and English. Rust lessons 1–10 and a preface are published in all three languages. Sources live in [`course/lessons/`](course/lessons/); Rust examples and exercise answers are checked on Windows, macOS and Linux. Lessons belong to course contents and are excluded from the main article feed. See the [Rust publication procedure](docs/rust-publication.md).
