...
4. **The fourth batch is ready for release.** Lessons 16–20 have Kazakh, Russian, and English versions, localized answers, and Cargo snapshots. Their text was edited in this pass and all five lessons are in the cumulative release manifest. Activation follows successful CI for the exact source commit and a production backup.
