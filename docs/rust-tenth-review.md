...
Before publication, repeat the novice walkthrough for all required tasks, obtain green CI for the exact release commit, and inspect the production pages and navigation after publication. Do not publish these drafts as part of the 41–45 release.
