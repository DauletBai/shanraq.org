...
1. Өйткені `required` браузерде тұр, ал сұраныс кез келген жерден келуі мүмкін: `curl`-дан, бөтен бағдарламадан, бөгде сайттағы формадан. Браузердегі тексеру адамға қателеспеуге көмектеседі; дұрыс емес деректен тек өңдеуші қорғайды.
