...
Скопируйте [`examples.json`](https://github.com/DauletBai/shanraq.org/blob/main/course/kazakh-ai/step-23/examples.json) в ту же папку, что и программа. Печатать все 13 карточек повторно не нужно: формат объяснён в уроке 22.
...
![Опорная схема урока 23](/static/course/kazakh-ai/map-23-classifier-ru.svg)
