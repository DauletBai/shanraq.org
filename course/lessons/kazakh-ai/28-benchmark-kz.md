...
Қазір тек сұрақ жіктегіші өлшенді. 30-сабақта осы қағида сұрақтан бастап дерек, мерзім және бас тарту тексерісіне дейінгі бүкіл дайын жүйеге қолданылады.
...
![28-сабақтың тірек сызбасы](/static/course/kazakh-ai/map-28-benchmark-kz.svg)
