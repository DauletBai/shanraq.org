...
Тег болмаса, `find` `None` береді — әрі бұл жетінші сабақтағы сол олқылық. `.text` деп сұрағанша ештеңе болмайды; сұрадыңыз — бағдарлама зиянсыз көрінетін жерде құлайды.

Осыдан ереже шығады: `find(...).text` емес, **әдепкісі бар `findtext` алады**. Екі әрекеттің орнына бір функция, әрі олқылық туралы шешім құлағанға дейін емес, бірден қабылданады.
