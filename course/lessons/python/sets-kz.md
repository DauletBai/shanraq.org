...
_Лид (summary):_ **Python курсының он бесінші сабағы. Тізімдегі бес атаудың әртүрлісі — төртеу: жиын қайталауды үнсіз жеп қояды. Оның есесіне екі выгрузкаға қойылған үш сұрақ үш таңбамен шешіледі: `&` — екеуінде де не бар, `-` — не қалмаған, `|` — бәрі бірге. Плюс `{}` — бос жиын емес, бос сөздік.**
...
Екі выгрузка келді — қаңтар мен ақпан. Екеуінде де не болды? Екіншісінде не қалмады? Не жаңа пайда болды? Тізіммен мұны кірістірілген циклмен санайды, әрі онда қателесу оңай.

Жиын — қайталаусыз және ретсіз жинақ. «Бар ма, жоқ па» үшін керегінің дәл өзі, әрі екі выгрузкаға қойылған үш сұрақты ол үш таңбамен шешеді.
...
Әр айдағы екі тауар выгрузкасы. Оларға қойылатын сұрақ бірдей: екеуінде де не
...
Осыдан ең жиі кездесетін адал қолданысы шығады: деректе неше **әртүрлі** мән бар екенін санау. `len(set(...))` мен `len(...)` — бір жол, әрі выгрузкада дубликат бар-жоғы бірден көрінеді.
...
Он жолда айырма байқалмайды. Циклмен тексерілетін жүз мың жолдық выгрузкада бұл — «бір секунд» пен «жарты сағаттың» айырмасы, әрі жиынды кейде тек тексеру үшін бастаудың жалғыз себебі де сол.
...
2. Екі выгрузкада `a - b` `b - a`-дан немен өзгеше?
...
**2. Бос орынды толтырыңыз.** `...` орнына екінші выгрузкада жоқ атауларды қалдыратын нәрсені қойыңыз.
...
Шолу жоғалуларды байқай бастайды. Бұрын ол келгенін санайтын; енді өткенімен салыстырғанда жаңа выгрузкада не **жоқ** екенін айта алады — ал бұл әлемнің емес, дереккөздің сынғанының алғашқы белгісі.
...
2. `a - b` — екінші выгрузкада не қалмағаны, `b - a` — онда не пайда болғаны. Сұрақтар әртүрлі, әрі қайсысына жауап бергеніңізді азайту реті шешеді.
