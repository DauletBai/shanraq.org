...
Середина ряда — половина стран — умещается в полосу шириной меньше трёх пунктов. Это и есть настоящий разброс этого ряда — а 18.97 описывают не разброс, а расстояние до Турции.
