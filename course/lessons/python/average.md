...
2. Вопрос про **типичное** — сначала посмотрите на распределение, квантили и выбросы. Близость среднего и медианы полезна, но сама по себе не делает меры взаимозаменяемыми: выбор зависит от смысла вопроса и цены крайних значений.
