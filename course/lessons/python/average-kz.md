...
_Лид (summary):_ **Python курсының отыз жетінші сабағы және ақша модулінің басы. Он ел, бір жыл: орташа 20.48 %, медиана 13.88 % — әрі орташа он елдің сегізіндегіден жоғары. Бір елді алыңыз: орташа 5.76-ға ығысады, медиана 0.03-ке. `mean`, `median`, `std` және өлшемді нәтижеге дейін таңдайтын ереже.**
...
Қатардың ортасы — елдердің жартысы — ені үш тармақтан кем жолаққа сыяды. Осы қатардың нағыз шашырауы — сол, ал 18.97 шашырауды емес, Түркияға дейінгі қашықтықты сипаттайды.
