...
_Лид (summary):_ **Python курсының отыз жетінші сабағы және ақша туралы модульдің басы. Он ел, бір жыл: орташа 20.48 %, медиана 13.88 % — әрі орташа он елдің сегізіндегіден жоғары. Бір елді алып тастаңыз: орташа 5.76-ға ығысады, медиана 0.03-ке. `mean`, `median`, `std` және өлшемді нәтижеге дейін таңдайтын ереже.**
