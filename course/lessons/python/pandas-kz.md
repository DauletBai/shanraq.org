...
2. `repeat=5`. `timeit.repeat` қанша сұрасаңыз, сонша өлшемнен тұратын тізім қайтарады; олардан орташа емес, ең кішісі алынады: артық уақыт — бұл әрқашан сол машинадағы басқа жұмыс, сіздің бағдарламаңыз емес.
