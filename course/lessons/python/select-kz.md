...
_Лид (summary):_ **Python курсының жиырма жетінші сабағы. Маска — «иә» мен «жоқтан» тұратын баған, әрі кесте сонымен тұтас сүзіледі, циклсіз. `df[маска]`, `.loc[маска, бағандар]`, `&`, `|`, `~` және міндетті жақшалар, `isin`, `between`, `str`, әрі сүзгіден кейін қайта саналмайтын қолтаңбалар.**
...
print()
print("== сүзгіден кейін қолтаңбалар қайта саналмайды")
rudny = df[df["city"] == "Рудный"]
print("қолтаңбалар:", rudny.index.tolist())
...
== сүзгіден кейін қолтаңбалар қайта саналмайды
қолтаңбалар: [2, 6, 9]
...
`df["amount"] > 10000` «иә» не «жоқ» деп жауап бермейді. Ол **бағанмен** жауап береді: әр жолға бір жауап, сол қолтаңбалармен. Қалғанының бәрі содан:
...
- маска кестемен рет бойынша емес, қолтаңба бойынша салыстырылады — pandas-тағының бәрі сияқты.
...
Сөзбен жазатын түрі де бар: `df.query("amount > 5000 and city == 'Қостанай'")` — жол ішінде `and` мен `or` дәл осылай істейді. Ол ұзын шарттарға ыңғайлы әрі шарт сырттан келгенде алмастырылмайды, бірақ кәдімгі кодта маскалы өрнекті жөндеу оңай: масканы басып шығаруға болады.

### Сүзгіден кейін қолтаңбалар қайта саналмайды

Үш жолды сүздік — қолтаңбалар `[2, 6, 9]` күйінде қалды, өйткені бұл сол жолдардың өзі. Сондықтан мысалдағы `loc[2]` мен `iloc[2]` әртүрлі нәтиже береді: біреуі қолтаңбасы 2 болатын жолды, екіншісі реті бойынша үшіншісін сұрайды.

Бұл — [жиырма бесінші сабақ](/read/py-dataframe-series-indeks-qoltanba) «айырмашылық жолдар сүзілген бойда шығады» деген дәл сол орын. Қолтаңбалар кедергі келтірсе, `reset_index(drop=True)` жолдарды қайта нөмірлейді; мұндағы `drop=True` — әйтпесе ескі қолтаңбалар жаңа бағанға айналады.
...
**Өз деректеріңізде.** Өз кестеңізді алып, оған үш шарт құрыңыз: біреуі қарапайым, біреуі екі бөліктен, біреуі `isin` не `between` арқылы. Әрқайсысына қанша жол келгенін басып шығарыңыз. Біреуіне нөл жол келсе — баған түрлерін тексеріңіз: санды жолмен салыстыру қате бермейді, ол жай ғана ешқашан ақиқат болмайды.

**Қалауыңыз бойынша.**

- Сол шартты `query` арқылы жазып, қайсысы оңай оқылатынын салыстырыңыз.
- `df[маска].reset_index(drop=True)` жасап, қолтаңбаларға не болғанын қараңыз.
...
1. Маска — «иә» мен «жоқтан» тұратын баған, әр жолға бір жауап, сол қолтаңбалармен. Бағанды санмен салыстыру бағанды тұтас емес, әр мәнді салыстырады, сондықтан жауап та баған болып шығады.
...
3. Өйткені сүзгі қолтаңбаларды қайта санамайды: қалған жолдарда олар бұрынғыдай. `loc[2]` қолтаңбасы 2 болатын жолды, `iloc[2]` реті бойынша үшіншісін сұрайды, ал сүзгіден кейін бұл әртүрлі жол.

### Жаттығуға

1. Салыстыру «иә» мен «жоқтан» тұратын баған береді, `sum()` келгенін санайды, ал `amounts[mask]` тек соларды қалдырады — қолтаңбаларымен бірге.
