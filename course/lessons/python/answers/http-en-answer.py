"""The answer to lesson 18's exercise, English: the dollar rate for one fixed day.
...
try:
    ...
    raise SystemExit(f"the server answered {error.code} {error.reason}")

print("status:", status, "| bytes received:", len(body))
...
print("the dollar:", rate, "tenge | change over the day:", change)
