"""The answer to lesson 18's exercise: the dollar rate for one fixed day.
...
try:
    ...
    raise SystemExit(f"сервер ответил {error.code} {error.reason}")

print("статус:", status, "| получено байт:", len(body))
...
print("доллар:", rate, "тенге | изменение за день:", change)
