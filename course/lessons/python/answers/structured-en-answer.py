"""Lesson 49 exercise: distinguish JSON and schema failures."""
...
print("not JSON:", counts["invalid_json"])
print("wrong schema:", counts["invalid_schema"])
print("years:", [item["year"] for item in accepted])
