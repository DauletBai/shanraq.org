"""The answer to lesson 16's exercise, Kazakh: a file read one value at a time.
...
def values(path):
    """(жыл, мән) жұбын бір-бірлеп береді; жарамсыз жолдарды аттап өтеді."""
...
stream = values(data)
print("біріншісі:", next(stream))
print("екіншісі:", next(stream))
...
print("2024-тен кейінгі жылдар:", [year for year in years if year > 2024])
