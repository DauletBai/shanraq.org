"""49-сабақ тапсырмасы: JSON және схема қателерін бөлу."""
...
print("қабылданды:", len(accepted))
print("JSON емес:", counts["invalid_json"])
print("схемаға сай емес:", counts["invalid_schema"])
print("жылдар:", [item["year"] for item in accepted])
