"""The answer to lesson 16's exercise, English: a file read one value at a time.
...
def values(path):
    """Yields (year, value) one at a time; unusable rows are skipped."""
...
stream = values(data)
print("the first:", next(stream))
print("the second:", next(stream))
...
print("years after 2024:", [year for year in years if year > 2024])
