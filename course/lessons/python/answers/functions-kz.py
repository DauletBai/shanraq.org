...
def average(series):
    """Қатар бойынша орташа; саны жоқ жылдар есепке кірмейді."""
    total = 0.0
    count = 0
...
def above(series, other):
    """Бірінші қатар екіншісінен жоғары болған жылдар.

    Екі қатардың бірінде саны жоқ жыл есепке кірмейді.
    """
    years = []
...
print(f"Қазақстан бойынша орташа: {average(kz):.2f}")
print(f"әлем бойынша орташа: {average(world):.2f}")
print("әлемдіктен жоғары:", above(kz, world))
