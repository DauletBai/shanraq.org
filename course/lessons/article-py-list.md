...
Циклов ещё не было, и они здесь не нужны: список умеет считать сумму,
находить наибольшее и сортировать себя сам.
"""
...
Зачем такое нужно? Кортеж — это **запись**, а не набор однотипных значений. `("хлеб", 280)` — строка чека: название и цена, у каждой позиции свой смысл. Список из четырёх цен — четыре одинаковых по смыслу числа. Правило простое: одинаковое по смыслу — список, разное — кортеж.
