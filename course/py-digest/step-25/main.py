"""Step 24 -- after lesson 46, the report says what it does not say.
...
New in this step: a list of limits at the foot of the page, and every line of it
is assembled from what the report has just counted -- the trend's own error, the
countries the link was short of, the ones with no money figure, the last year
that exists. A page of numbers with nothing beside them reads as a page of
facts; this is the closing move of the module, and it costs one function.
...
def main(argv=()):
    ...
    if dry:
        ...
        bet.write(report, PICTURE, PAGE, TITLE, SOURCE, spread=spread, index=index,
                  ...
                  limits=limits, about=notes, verified=verified)
