"""Step 21 -- after lesson 42, the digest that refuses what it cannot support.
...
New in this step: the digest asks whether prices and money moved together
across the countries it follows -- and answers that it cannot say. Three
countries always produce a correlation, and that number means nothing: on ten
neighbours in lesson 42 a single country moved it by 1.3 and flipped its sign.
So esep.baylanys() carries a floor, prints the count of countries beside any
answer, and where the floor is not reached the page says what it would take
...
def main(argv=()):
    ...
    if dry:
        ...
        bet.write(report, PICTURE, PAGE, TITLE, SOURCE, spread=spread, index=index,
                  money=aqsha, money_source=AQSHA_SOURCE, link=link, about=notes)
