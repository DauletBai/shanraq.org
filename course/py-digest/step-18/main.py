"""Step 18 -- after lesson 38, the digest that says how many times prices grew.
...
New in this step: a third table -- the price index from the first year of each
series, the multiplier, and what a thousand tenge of the base year is worth at
the end of it. Percentages are multipliers, so the run of years is their product
(sholu/esep.py, indeks) and a gap in the years is reported rather than skipped.
